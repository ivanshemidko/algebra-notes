...
\begin{theorem}
    ...
    \begin{proof}
        ...
        Это означает, что строки (столбцы) матрицы $G_{\mathbf{w}}$ линейно зависимы, поэтому
        \[
...
\begin{theorem}[Неравенство Коши–Буняковского–Шварца]
    ...
    \begin{proof}
        ...
        \[
            ...
            = \det \begin{pmatrix} \langle v,v\rangle & \langle v,w\rangle \\ \langle w,v\rangle & \langle w,w\rangle \end{pmatrix}
...
\begin{theorem}[Неравенство Гёльдера]
    ...
    \]
    где норма задаётся как $\|f\| = \left(\int_0^1 f^p\,dx\right)^{1/p}$.
\end{theorem}


\begin{remark}
    Неравенство Гёльдера надо честно доказывать, но частный случай (пример 2) мы доказать можем.
\end{remark}
