...
\begin{example}
	Посчитаем $|SL(\mathbb{F}_p^n)|$. Введем отображение $GL(\mathbb{F}_p^n) \overset{\det}{\to} \mathbb{F}_p^{\times}$, где $\ker\left(\det\right) = SL(\mathbb{F}_p^{\times})$, тогда по следствию:
	\[
